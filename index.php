                  ...
                  <a href="#">
                    <div class="d-flex align-items-center block-unit">
                      ...
                      <div class="d-none d-lg-block">
                        ...
                        <span class="h6">cloudstore265@gmail.com</span>
                      </div>
                    </div>
                  </a>
                </li>
            ...
            <div class="col-4 col-md-4 col-lg-8">
              <nav class="site-navigation text-left" role="navigation">
                ...
                <ul class="site-menu js-clone-nav d-none d-lg-block">
                  <li class="active">
                    <a href="">Welcome to Cloud Storage</a>
                  </li>
        ...
        <div class="container">
          <div class="row align-items-center justify-content-center text-center">
            <div class="col-md-10">
              ...
              <p class="mb-5">Fast Access Cloud Server</p>
              <p>
                <a href="/cloudstore1/login" class="btn btn-primary py-3 px-5 rounded-0">Login</a>
                <a href="/cloudstore1/register" class="btn btn-primary py-3 px-5 rounded-0">Register</a>
              </p>
            </div>
          </div>
        </div>
        ...
        <div class="nonloop-block-4 owl-carousel" data-aos="fade">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header"> 
                  <img src="image/Rahul.jpg" alt="Image placeholder">
                  <h3 class="block-38-heading">Rahul</h3>
          ...
          <div class="item col-md-6 mx-auto">
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="images/Rajeshwaree.jpg" alt="Image placeholder">
                  <h3 class="block-38-heading">Rajeshwaree</h3>
          ...
          <div class="item col-md-6 mx-auto">
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header"> 
                  <img src="images/Shambhavi.jpg" alt="Image placeholder">
                  <h3 class="block-38-heading">Shambhavi</h3>
